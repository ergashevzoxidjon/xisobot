...
CONTEXTS = {
    ...
    "finance/report.html": dict(
        ...
        income_today_total_all=Decimal("500000.00"),
...
checks = [
    ...
    ("menejer", "orders/list.html", "Yangi buyurtma", False,
     "buyurtma ro'yxatida 'Yangi buyurtma' tugmasi yo'q (endi faqat pipeline orqali)"),
